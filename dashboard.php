...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["snoDelete"])) {
        ...
        // insert
        $sql = "INSERT INTO `notes` (`title`, `description`, `tstamp`, `username`) VALUES ('$title', '$description', current_timestamp(), '".$user."');";
...
<body>
    ...
    <div class="container my-4">
        <?php
        $sql2 = "SELECT * FROM `notes` WHERE `username` LIKE '".$user."'";
